        ...
        updateUser() {
            ...
            fetch(`https://test-users-api.herokuapp.com/users/${userId}`, {
                ...
                .then(data => {
                    ...
                    if (data.status === 200) {
                        document.querySelector("#js-delete-info").textContent ='';
                        document.querySelector("#js-update-info").textContent = `User ID: ${data.data.id} has been updated`;
                        document.querySelector(".js-new-user").textContent = "";
                        ...
                        document.querySelector("#js-update-info").textContent = `There is on user with this ID: ${data.data.id}!`;
                    }
                })
                .catch(err => console.log(err));
        }
