 ...
 */
const getUsersByEyeColor = (arr, color) => arr.filter(function (el) {
 ...
 */
const getUsersByGender = (arr, gender) => arr.filter(function (el) {
    if (el.gender === gender) {
        return el;
    }
});
 ...
 */
const getInactiveUsers = arr => arr.filter(function (el) {
 ...
 */
const getUserByEmail = (arr, email) => arr.find(function (el) {
    if (el.email === email) {
        return el;
    }
});
 ...
 */
const getUsersWithAge = (arr, min, max) => arr.filter(function (el) {
 ...
 */
const getTotalBalance = arr => arr.reduce(function (acc, el) {
 ...
 */
const getUsersByFriend = (arr, name) => arr.filter(function (el) {
    if (el.friends.indexOf(name) != -1) {
        return el;
    }
});
...
const getAllSkills = arr => arr
    .reduce((allSkills, user) => user.skills ? allSkills.concat(user.skills) : allSkills, [])
...
console.log(getUserNamesSortedByFriendsCount(users)); // [ 'Moore Hensley', 'Sharlene Bush', 'Elma Head', 'Carey Barr', 'Blackburn Dotson', 'Sheree Anthony', 'Ross Vazquez' ]